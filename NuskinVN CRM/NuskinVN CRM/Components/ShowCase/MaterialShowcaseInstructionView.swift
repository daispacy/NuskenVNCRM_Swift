...
public class MaterialShowcaseInstructionView: UIView {
  ...
  internal static let PRIMARY_TEXT_SIZE: CGFloat = Theme.fontSize.larger
  internal static let SECONDARY_TEXT_SIZE: CGFloat = Theme.fontSize.normal
  ...
  private func addPrimaryLabel() {
    ...
    if let font = primaryTextFont {
      ...
      primaryLabel.font = UIFont(name: Theme.font.bold, size: primaryTextSize)
    }
  ...
  private func addSecondaryLabel() {
    ...
    if let font = secondaryTextFont {
      ...
      secondaryLabel.font = UIFont(name: Theme.font.normal, size: secondaryTextSize)
    }
