...
public class MaterialShowcase: UIView {
  ...
  let BACKGROUND_DEFAULT_COLOR = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.6)
...
//      backgroundPromptColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 0.3412466989)
  ...
  public func setTargetView(barButtonItem: UIBarButtonItem) {
    if let view = (barButtonItem.value(forKey: "view") as? UIView)?.subviews.first {
      targetView = view
      targetHolderColor = #colorLiteral(red: 0.003921568627, green: 0.5411764706, blue: 0.6862745098, alpha: 1)
       aniRippleColor = #colorLiteral(red: 0.003921568627, green: 0.5411764706, blue: 0.6862745098, alpha: 0.6557548415)
    }
  }
