...
- (void)commonInit {
    ...
    self.selectedIndicatorColor = self.selectedIndicatorColor;
    ...
    self.navigationBar.textLabel.textColor = [UIColor whiteColor];
    self.navigationBar.textLabel.font = [UIFont fontWithName:@"Roboto-Medium" size:20];
